...
export function registerWorkflowRoutes(app: Hono, services: CoreServices) {
  ...
  app.post('/v1/deals/:id/move', async (c) => {
  ...
  app.get('/v1/deals/pipeline', async (c) => {
    const service = services.deals as any
  ...
  app.get('/v1/deals/stats', async (c) => {
    const service = services.deals as any
  ...
  app.post('/v1/sequences/:id/enroll', async (c) => {
  ...
  app.post('/v1/sequence_enrollments/:id/unenroll', async (c) => {
  ...
  app.post('/v1/tags/:id/attach', async (c) => {
  ...
  app.post('/v1/tags/:id/detach', async (c) => {
    const service = services.tags as any
  ...
  app.post('/v1/activities/log', async (c) => {
