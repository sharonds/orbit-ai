...
Orbit AI — CRM infrastructure for AI agents and developers. TypeScript monorepo (Turborepo + pnpm). All 5 packages implemented: `@orbit-ai/core`, `@orbit-ai/api`, `@orbit-ai/sdk`, `@orbit-ai/cli`, `@orbit-ai/mcp`. 1,127 tests passing. Not yet published to npm.
...
pnpm -r test              # Run all tests (vitest) — expect 1127 passing
...
**Test baseline**: 1127 tests (update this number after each merge to main)
