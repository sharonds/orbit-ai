...
Orbit AI — CRM infrastructure for AI agents and developers. TypeScript monorepo (Turborepo + pnpm). All 5 packages implemented: `@orbit-ai/core`, `@orbit-ai/api`, `@orbit-ai/sdk`, `@orbit-ai/cli`, `@orbit-ai/mcp`. 1,130 tests passing. Not yet published to npm.
...
pnpm -r test              # Run all tests (vitest) — expect 1130 passing
...
**Test baseline**: 1130 tests (update this number after each merge to main)
