...
pnpm -r test              # Run all package tests (vitest) — expect 2155 passing
...
**Test baseline**: 2155 package tests (update this number after each merge to main)
