...
4. Shared contracts still match the core spec: Pass — the core spec example already reflects the remediated `system.apiKeys` admin surface and sanitized read contract.
